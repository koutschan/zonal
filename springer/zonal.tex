...
See the example at the end of Section \ref{sec:Package} of the case $\kappa=(4,1,1)$ and $\lambda=(3,3)$, which is also compatible with the build-in package in SageMath.
\end{rem}
