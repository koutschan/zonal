...
It seems that James \cite{James1} has claimed that for all ``relevant'' pairs $(\kappa,\lambda)$, $c_{\kappa,\lambda}>0$. Due to the nonnegative numerator of the summation in \eqref{eq:CRec}, it indicates that if $\rho_\kappa\leq\rho_\lambda$,  $c_{\kappa,\lambda}=0$. 
