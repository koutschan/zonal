...
\]
where for positive integer $m$,  $\left(a\right)_{m}:=a\left(a+1\right)\cdots\left(a+m-1\right)$ is the the Pochhammer symbol.
...
\noindent\colorbox{tan}{\begin{minipage}[t]{1\columnwidth}
\noindent \begin{flushleft}
\textcolor{cyan}{
sage: Coeffi({[}2, 1{]}, {[}1, 1, 1{]})\\
$18/5$\\
~\\
sage: MZonal({[}2, 1{]}, {[}a, b, c{]})\\
$a^{2}b+ab^{2}+a^{2}c+b^{2}c+ac^{2}+bc^{2}$\\
~\\
sage: CZonal{[}{[}2, 1{]}, {[}a, b, c{]})\\
$12/5\left(a^{2}b+ab^{2}+a^{2}c+b^{2}c+ac^{2}+bc^{2}\right)+18/5abc$
}
\par\end{flushleft}
