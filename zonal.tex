...
\begin{example}
  ...
  matrices~$W$. In Mathematica, the command\\[1ex]
%
  \centerline{\texttt{RandomVariate[WishartMatrixDistribution[nu, IdentityMatrix[2]]]}}\vspace{1ex}
%
...
the coefficients $c_{\kappa,\lambda}$, in the case $n=3$. 
%\begin{itemize}
%\item $n=2$
%\[
