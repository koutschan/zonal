...
The following tables \cite[p.~238]{Muirhead} show
...
\end{equation}
where for $\lambda=\left(\lambda_1,\ldots,\lambda_k\right)$
the sum is over all
\[
  \mu=\left(\lambda_1,\ldots,\lambda_{r-1},\lambda_r+t,\lambda_{r+1},\ldots,
  \lambda_{s-1},\lambda_s-t,\lambda_{s+1},\ldots,\lambda_k\right)
\]
for $t=1,\ldots,\lambda_s$ such that by rearranging the tuple~$\mu$
