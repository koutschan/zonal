...
\end{lemma}
\begin{proof}
Given a partition $\lambda$, denote $len(\lambda)$ be its number of parts. Assume that $len(\kappa)=k$. Then, the
 ...
 0 = \mathcal{C}_{\kappa}(y_1,\dots,y_{k-1})= 
  \!\!\!\!\!\sum_{\genfrac{}{}{0pt}{}{\lambda\leq\kappa}{len(\lambda)<k}}\!\!\!\!\!
      c_{\kappa,\lambda} \underbrace{M_{\lambda}(y_1,\dots,y_{k-1})}_{\neq0} \quad +
   \sum_{\genfrac{}{}{0pt}{}{\lambda\leq\kappa}{len(\lambda)\geq k}}\!\!\!\!\!
