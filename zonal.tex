...
We now present a conjecture about the coefficients $c_{\kappa,\lambda}$ when
both $\kappa$ and $\lambda$ have exactly two parts.
\begin{conj}
  If $n=2m$ is an even integer with $n\geq2$, then for $0\leq j\leq i<m$ we
  have
  \[
  ...
  \]
  If $n=2m+1$ is an odd integer with $n\geq3$, then for $0\leq j\leq i<m$ we
  have
  \[
